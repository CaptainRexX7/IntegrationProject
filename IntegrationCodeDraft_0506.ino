...
//Right Color Sensor, CS1 !!make sure these align with the actual placements of the color sensors!!
#define RS0 28
#define RS1 29
#define RS2 30
#define RS3 31
...
//Left Color Sensor, CS2 !!make sure these align with the actual placements of the color sensors!!
#define LS0 33
#define LS1 34
#define LS2 35
#define LS3 36
...
//Arm Color Sensor, CS3 !!make sure these align with the actual placements of the color sensors!!
#define AS0 13
#define AS1 14
#define AS2 15
#define AS3 16
...
// Ultrasonic Sensor _1_ !I added the numbers to the end of the names to differentiate from each ultrasonic sensor, ie echopin -> echopin1, I also added the other ultra sonic sensor!
