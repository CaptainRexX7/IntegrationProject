...
#define WorkingArm 185 //changed 45
#define SmallBox 77
#define LargeBox 95
...
//Timing
#define speedR 24 //slowed down to give the light sensors more time to read
#define speedL 24 //slowed down to give the light sensors more time to read
...
void findBox()
{
  ...
  if(Ultrasonic() <= targetDistance){
    ...
    //state = FollowLine; //Temporary. Ends the program early for testing
    }
  }
  else{
    Forward();
