...
#define targetDistance 15 // the vehicle needs to be within 10cm
...
#define straight 8100
#define PUStraight 3000
...
enum {FindBox, FollowLine, PlaceBox, End, Finish}; //I removed the return state
